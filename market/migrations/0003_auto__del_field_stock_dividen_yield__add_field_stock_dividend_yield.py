...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Stock.dividend_yield'
        db.add_column('market_stock', 'dividend_yield', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Stock.dividend_yield'
        db.delete_column('market_stock', 'dividend_yield')
