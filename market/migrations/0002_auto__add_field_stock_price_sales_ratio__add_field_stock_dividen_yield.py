...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Stock.price_sales_ratio'
        db.add_column('market_stock', 'price_sales_ratio', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)

        # Adding field 'Stock.dividen_yield'
        db.add_column('market_stock', 'dividen_yield', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Stock.price_sales_ratio'
        db.delete_column('market_stock', 'price_sales_ratio')

        # Deleting field 'Stock.dividen_yield'
        db.delete_column('market_stock', 'dividen_yield')
    ...
    models = {
        ...
        'market.stock': {
            ...
            'dividen_yield': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
