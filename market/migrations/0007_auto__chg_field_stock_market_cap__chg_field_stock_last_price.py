...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Stock.market_cap'
        db.alter_column('market_stock', 'market_cap', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Stock.last_price'
        db.alter_column('market_stock', 'last_price', self.gf('django.db.models.fields.FloatField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Stock.market_cap'
        db.alter_column('market_stock', 'market_cap', self.gf('django.db.models.fields.FloatField')(default=0))

        # Changing field 'Stock.last_price'
        db.alter_column('market_stock', 'last_price', self.gf('django.db.models.fields.FloatField')(default=0))
    ...
    models = {
        ...
        'market.stock': {
            ...
            'dividend_yield': ('django.db.models.fields.FloatField', [], {'default': '0', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_price': ('django.db.models.fields.FloatField', [], {'default': '0', 'null': 'True'}),
            'market_cap': ('django.db.models.fields.FloatField', [], {'default': '0', 'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '20'}),
            'price_sales_ratio': ('django.db.models.fields.FloatField', [], {'default': '0', 'null': 'True'}),
