...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Stock.price_sales_ratio'
        db.alter_column('market_stock', 'price_sales_ratio', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Stock.dividend_yield'
        db.alter_column('market_stock', 'dividend_yield', self.gf('django.db.models.fields.FloatField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Stock.price_sales_ratio'
        db.alter_column('market_stock', 'price_sales_ratio', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Stock.dividend_yield'
        db.alter_column('market_stock', 'dividend_yield', self.gf('django.db.models.fields.FloatField')())
