...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Stock.volatility'
        db.add_column('market_stock', 'volatility', self.gf('django.db.models.fields.FloatField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Stock.volatility'
        db.delete_column('market_stock', 'volatility')
